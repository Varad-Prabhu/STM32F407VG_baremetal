...
/* WWDG peripheral base address */
#define WWDG_BASE    (APB1PERIPH_BASE + 0x2C00U)

/* WWDG register definition structure */
typedef struct
{
    volatile uint32_t CR;       /* Offset: 0x00 */
    volatile uint32_t CFR;      /* Offset: 0x04 */
    volatile uint32_t SR;       /* Offset: 0x08 */
} WWDG_TypeDef;
...
/* WWDG Status Register Bits */
#define WWDG_SR_EWIF_Pos      0U

/* Prescaler values */
#define WWDG_PRESCALER_1      0U
#define WWDG_PRESCALER_2      1U
#define WWDG_PRESCALER_4      2U
#define WWDG_PRESCALER_8      3U

/* Interrupt number for WWDG */
#define WWDG_IRQn             0U
...
/* CAN Tx Mailbox register structure */
typedef struct
{
...
/* CAN Rx Mailbox register structure */
typedef struct
{
...
typedef struct
{
    ...
    uint32_t RESERVED0[88];         /* Offset: 0x020 */

    CAN_TxMailBox_TypeDef sTxMailBox[3];

    CAN_FIFOMailBox_TypeDef sFIFOMailBox[2];

    uint32_t RESERVED1[12];         /* Offset: 0x1D0 */

    volatile uint32_t FMR;          /* Offset: 0x200 */
    volatile uint32_t FM1R;         /* Offset: 0x204 */
    uint32_t RESERVED2;             /* Offset: 0x208 */
    volatile uint32_t FS1R;         /* Offset: 0x20C */
    uint32_t RESERVED3;             /* Offset: 0x210 */
    volatile uint32_t FFA1R;        /* Offset: 0x214 */
    uint32_t RESERVED4;             /* Offset: 0x218 */
    volatile uint32_t FA1R;         /* Offset: 0x21C */
    uint32_t RESERVED5;             /* Offset: 0x220 */
    uint32_t RESERVED6[7];          /* Offset: 0x224 */
...
/* Interrupt number for CAN */
#define CAN1_TX_IRQn      19U
#define CAN1_RX0_IRQn     20U
#define CAN1_RX1_IRQn     21U
#define CAN1_SCE_IRQn     22U
#define CAN2_TX_IRQn      63U
#define CAN2_RX0_IRQn     64U
#define CAN2_RX1_IRQn     65U
#define CAN2_SCE_IRQn     66U

/* Alternate function selection for CAN */
...
{
    volatile uint32_t CR;       /* Offset: 0x00 */
    volatile uint32_t CSR;      /* Offset: 0x04 */
} PWR_TypeDef;
...
typedef struct
{
    volatile uint32_t TR;       /* Offset: 0x00 */
    volatile uint32_t DR;       /* Offset: 0x04 */
    volatile uint32_t CR;       /* Offset: 0x08 */
    volatile uint32_t ISR;      /* Offset: 0x0C */
    volatile uint32_t PRER;     /* Offset: 0x10 */
    volatile uint32_t WUTR;     /* Offset: 0x14 */
    volatile uint32_t CALIBR;   /* Offset: 0x18 */
    volatile uint32_t ALRMAR;   /* Offset: 0x1C */
    volatile uint32_t ALRMBR;   /* Offset: 0x20 */
    volatile uint32_t WPR;      /* Offset: 0x24 */
    volatile uint32_t SSR;      /* Offset: 0x28 */
    volatile uint32_t SHIFTR;   /* Offset: 0x2C */
    volatile uint32_t TSTR;     /* Offset: 0x30 */
    uint32_t RESERVED1;         /* Offset: 0x34 */
    volatile uint32_t TSSSR;    /* Offset: 0x38 */
    volatile uint32_t CALR;     /* Offset: 0x3C */
    volatile uint32_t TAFCR;    /* Offset: 0x40 */
    volatile uint32_t ALRMASSR; /* Offset: 0x44 */
    volatile uint32_t ALRMBSSR; /* Offset: 0x48 */
    uint32_t RESERVED2;         /* Offset: 0x4C */
    volatile uint32_t BKPR[20]; /* Offset: 0x50 */
} RTC_TypeDef;

/* RTC Pointer */
#define RTC    ((RTC_TypeDef *)RTC_BASE)

/* RCC Backup Domain Register Bits */
...
/* RCC CSR Bits (if using LSI) */
#define RCC_CSR_LSION_Pos       0U
#define RCC_CSR_LSIRDY_Pos      1U

/* RTC Write Protection Keys */
#define RTC_WPR_DISABLE_KEY1    0xCAU
#define RTC_WPR_DISABLE_KEY2    0x53U
#define RTC_WPR_ENABLE_KEY      0xFFU
...
/* RTC Prescaler Register Bits */
#define RTC_PRER_PREDIV_A_Pos   16U
#define RTC_PRER_PREDIV_S_Pos   0U

/* RTC TR Register Bits */
