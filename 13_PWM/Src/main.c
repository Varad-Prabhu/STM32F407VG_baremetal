...
int main(void)
{
    ...
    /* Timer clock = 84 MHz */
    /* Timer tick = 84 MHz / (8399 + 1) = 10 kHz */
    /* PWM frequency = 10 kHz / (9999 + 1) = 1 Hz */
    /* CCR1 = 4999 -> Duty cycle ≈ 50% */
    TIM2_PWM_Init(8399, 9999, 4999);   /* Prescaler = 8399, Auto-reload = 9999, Duty cycle = 50% */

    while (1)
    {
        /* PWM is generated by TIM2 */
    }
