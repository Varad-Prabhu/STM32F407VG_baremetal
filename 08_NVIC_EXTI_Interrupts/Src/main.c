...
int main(void)
{
    ...
    EXTI_ConfigGPIO(0, GPIO_PORT_A);    /* Configure EXTI line 0 to be connected to GPIOA */
    EXTI_EnableInterrupt(0);            /* Enable interrupt for EXTI line 0 */
    EXTI_EnableRisingTrigger(0);        /* Enable rising trigger for EXTI line 0 */
    EXTI_DisableFallingTrigger(0);      /* Disable falling trigger for EXTI line 0 */
